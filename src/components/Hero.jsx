        ...
        <div className='py-2.5'>
            ...
            <div className='max-w-[1160px] mx-auto px-4'>
                <div className='flex items-center gap-[5px] pt-[17px] max-xl:overflow-x-auto pb-2'>
                    ...
                    <select value={id} onChange={handleSelectChange} className={`${id === "lofi" || id === "song" || id === "more" ? "bg-black text-white" : ""}  outline-none !text-xs text-customBlack py-[5.84px] !pl-[9.2px] !pr-[22.15px] cursor-pointer border appearance-none border-dark-black rounded-[9px] font-medium max-sm:px-3 max-sm:py-[2.5px]`}>
